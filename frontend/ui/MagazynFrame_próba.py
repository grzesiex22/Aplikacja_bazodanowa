...
class ButtonDelegate(QStyledItemDelegate):
    ...
    def createEditor(self, parent, option, index):
        # Tworzy przycisk jako edytor
        button = QPushButton("Edit", parent)
        button.clicked.connect(lambda: self.on_button_clicked(index))
        return button

    def setEditorData(self, editor, index):
        # Nie potrzeba ustawiać danych w przycisku
        pass

    def setModelData(self, editor, model, index):
        # Nie zapisujemy danych z edytora do modelu
        pass
    ...
    def paint(self, painter, option, index):
        ...
        btn.rect = QtCore.QRect(rect.left(), rect.top(), 100, rect.height())
        btn.text = 'Przypisz'
    ...
    def updateEditorGeometry(self, editor, option, index):
        editor.setGeometry(option.rect)  # Ustawiamy geometrię edytora, aby pasował do komórki
...
class WarehouseFrame(QtWidgets.QFrame):
    ...
    def load_column_headers(self, model_name, model):
        ...
        try:
            ...
            headers = {
                "czesc": ["ID", "Typ Serwisu", "Nazwa Elementu", "Ilość", "Akcja"],
    ...
    def setup_frame(self):
        ...
        # Dodanie delegata do ostatniej kolumny
        self.delegate = ButtonDelegate(self.tableView_magazyn)
        self.tableView_magazyn.setItemDelegateForColumn(4, self.delegate)
        ...
        if self.screen_type == ScreenType.CZESCI:
            try:
                ...
                if response.status_code == 200:
                    ...
                    # # # Dodanie delegata dla kolumny z przyciskami
                    # self.button_delegate = ButtonDelegate()
                    # self.tableView_magazyn.setItemDelegateForColumn(self.model_pojazd.columnCount()-1,
                    #                                          self.button_delegate)
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    for czesc in czesci_data:
                        ...
                        # # Dodanie przycisku do ostatniej kolumny
                        # btn = QPushButton("Edit")
                        # btn.clicked.connect(self.handleButtonClicked)  # Obsługa kliknięcia
                        # self.tableView_magazyn.setIndexWidget(row_index, btn)
