...
class WyposazenieFrame(QtWidgets.QFrame):
    def __init__(self, parent=None, api_url=None):
        super(WyposazenieFrame, self).__init__(parent)
    ...
    def on_table_double_click(self, index):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("dzialaaaaaaaaaaaaaaaaaaaa")
    ...
    def show_raport_frame(self):
        ...
        self.raport_dialog = SimpleGenerateRaport(parent=self, save_callback=self.generate_raport, header_title="Raport wyposażenia")
